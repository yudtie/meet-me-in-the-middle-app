export default function Footer() {
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t border-[#d0d0d0] py-2 px-3 z-30">
      <div className="max-w-7xl mx-auto flex flex-row items-center justify-between text-sm">
